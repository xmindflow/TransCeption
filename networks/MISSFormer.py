...
class MISSFormer(nn.Module):
    def __init__(self, num_classes=9, if_bridge=True, token_mlp_mode="mix_skip", encoder_pretrained=True):
        super().__init__()
...
#     # Remember to change the '.segment' to 'segment' in the import part
#     net = MISSFormer(num_classes = 9, if_bridge=False).cuda()
#     out = net(torch.rand(1,3,224,224).cuda())
#     print(out.shape)
